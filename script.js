...
const allSongs = [
    ...
    },
    {
        ...
        artist: "Imran khan",
        duration: "3:01",
        src: "C:\Users\91834\OneDrive\Desktop\song player\song\Satisfya_320(PagalWorld.com.so) (1).mp3"
    }
...
const seek = (event) => {
    ...
    const newTime = (offsetX / progressBarContainer.offsetWidth) * audio.duration;
